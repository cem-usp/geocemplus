...
export default function BootomBar(props) {
    ...
    return(
        ...
        className="position-fixed">
            ...
            <Grid xs={12} sm={1.5}  sx={{width: '5px'}}>
            ...
            <Grid xs={12} sm={1.5} sx={{minWidth: '5px', fontSize: '1rem'}}>
                <Button value="zoom_out" variant="contained" aria-label="zoom_out" sx={{backgroundColor: "#042E6F", minWidth: '5px', fontSize: '1rem'}}onClick={() => {
                    const map_view = props.map.getView()
                    const curr_zoom = map_view.getZoom()
                    map_view.setZoom(curr_zoom-0.5)
                }}>
            ...
            <Grid xs={12} sm={1.5}>
                ...
                sx={{backgroundColor: "#042E6F", width: '5px'}} 
                >
            ...
            <Grid xs={12} sm={1.5}>
                ...
                selected={props.basicOptions['bounds']} 
            ...
            <Grid xs={12} sm={1.5}>
                ...
                selected={props.basicOptions['map']} 
                onChange={props.onBasicOptionsChange}>
            ...
            <Grid xs={12} sm={1.5}>
                ...
                selected={props.basicOptions['mapillary']} 
                onChange={props.onBasicOptionsChange}>
            ...
            <Grid xs={12} sm={1.5}>
                <Button value="" variant="contained" aria-label="" sx={{backgroundColor: "#042E6F", width: '5px'}}>
